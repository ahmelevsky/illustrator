...
function saveFile( docRef, fileNameBody, exportInfo) {
    ...
    var idAs = charIDToTypeID( "As  " );
        ...
        desc12.putEnumerated( idPGIT, idPGIT, idPGIN );
        var idPNGf = charIDToTypeID( "PNGf" );
        var idPNGf = charIDToTypeID( "PNGf" );
        var idPGAd = charIDToTypeID( "PGAd" );
        desc12.putEnumerated( idPNGf, idPNGf, idPGAd );
        var idCmpr = charIDToTypeID( "Cmpr" );
        desc12.putInteger( idCmpr, 9 );
    var idPNGF = charIDToTypeID( "PNGF" );
    desc11.putObject( idAs, idPNGF, desc12 );
    var idIn = charIDToTypeID( "In  " );
    desc11.putPath( idIn, new File( exportInfo.destination + "/" + fileNameBody + ".png") );
    var idDocI = charIDToTypeID( "DocI" );
    desc11.putInteger( idDocI, 195 );
